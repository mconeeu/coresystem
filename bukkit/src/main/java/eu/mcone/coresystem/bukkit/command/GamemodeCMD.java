        ...
        if (args.length == 1) {
            ...
            try {
                ...
                if (args[0].equalsIgnoreCase("1")) {
                    ...
                    BukkitCoreSystem.getInstance().getMessager().send(sender, "§4Bitte benutze: §c/gm §4oder §c/gamemode <Gamemode> [<Spieler>]");
                    return true;
                }
            ...
            BukkitCoreSystem.getInstance().getMessager().send(sender, "§4Bitte benutze: §c/gm §4oder §c/gamemode <GamemodeCMD> [<Spieler>]");
        }
