...
import eu.mcone.coresystem.bukkit.npc.nms.player.controller.EntitySenses;
import eu.mcone.coresystem.bukkit.npc.nms.player.navigation.NavigationAbstract;
...
public abstract class EntityHuman extends net.minecraft.server.v1_8_R3.EntityHuman {

    public int a_;
    protected int b_;
    private eu.mcone.coresystem.bukkit.npc.nms.player.controller.ControllerLook lookController;
    protected eu.mcone.coresystem.bukkit.npc.nms.player.controller.ControllerMove moveController;
    protected eu.mcone.coresystem.bukkit.npc.nms.player.controller.ControllerJump g;
    private EntityAIBodyControl b;
    protected eu.mcone.coresystem.bukkit.npc.nms.player.navigation.NavigationAbstract navigation;
    public PathfinderGoalSelector goalSelector;
    public PathfinderGoalSelector targetSelector;
    private EntityLiving goalTarget;
    private eu.mcone.coresystem.bukkit.npc.nms.player.controller.EntitySenses bk;
    ...
    public EntityHuman(World world, GameProfile gameprofile) {
        ...
        this.lookController = new eu.mcone.coresystem.bukkit.npc.nms.player.controller.ControllerLook(this);
        this.moveController = new eu.mcone.coresystem.bukkit.npc.nms.player.controller.ControllerMove(this);
        this.g = new eu.mcone.coresystem.bukkit.npc.nms.player.controller.ControllerJump(this);
        this.b = new EntityAIBodyControl(this);
        this.navigation = this.b(world);
        this.bk = new eu.mcone.coresystem.bukkit.npc.nms.player.controller.EntitySenses(this);
    ...
    protected eu.mcone.coresystem.bukkit.npc.nms.player.navigation.NavigationAbstract b(World world) {
        return new eu.mcone.coresystem.bukkit.npc.nms.player.navigation.Navigation(this, world);
    }
    ...
    public eu.mcone.coresystem.bukkit.npc.nms.player.controller.ControllerLook getControllerLook() {
        return this.lookController;
    }

    public eu.mcone.coresystem.bukkit.npc.nms.player.controller.ControllerMove getControllerMove() {
        return this.moveController;
    }

    public eu.mcone.coresystem.bukkit.npc.nms.player.controller.ControllerJump getControllerJump() {
        return this.g;
    }
    ...
    protected int getExpValue(net.minecraft.server.v1_8_R3.EntityHuman entityhuman) {
        if (this.b_ > 0) {
            int i = this.b_;
    ...
    public void b(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.setBoolean("CanPickUpLoot", true);
    ...
    public void m() {
        ...
        if (!this.world.isClientSide && true && !this.aP && this.world.getGameRules().getBoolean("mobGriefing")) {
        ...
        if (i > -1) {
            ...
            if (flag && this.a(itemstack)) {
                ...
                if (itemstack.getItem() == Items.DIAMOND && entityitem.n() != null) {
                    net.minecraft.server.v1_8_R3.EntityHuman entityhuman = this.world.a(entityitem.n());
                    if (entityhuman != null) {
    ...
    protected void D() {
        if (this.persistent) {
            ...
            net.minecraft.server.v1_8_R3.EntityHuman entityhuman = this.world.findNearbyPlayer(this, -1.0D);
            if (entityhuman != null) {
