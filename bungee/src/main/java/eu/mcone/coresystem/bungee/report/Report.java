...
public class Report {
    ...
    public Report(ProxiedPlayer reporter, ProxiedPlayer reportedPlayer, ReportReason reason){
        ...
        BungeeCoreSystem.getInstance().getMessenger().send(reporter, "§2Du hast erfolgreich den Spieler §f" + reportedPlayer.getName() + "§2 erfolgreich reportet.");
        ...
        BungeeCoreSystem.getInstance().getMessenger().send(reporter, "§2Du kannst den Status deines Reports auf dieser Seite einsehen: §fhttps://www.mcone.eu/dashboard/ticket.php?id=" + id);
    }
