    ...
    public void execute(final CommandSender sender, final String[] args) {
        if (sender instanceof ProxiedPlayer) {
            ...
            if (MsgCMD.reply.containsKey(p.getUuid())) {
                ...
                if (t != null) {
                    if (t.getSettings().getPrivateMessages().equals(PlayerSettings.Sender.NOBODY)) {
                        ...
                        if (p.getSettings().getPrivateMessages().equals(PlayerSettings.Sender.NOBODY)) {
                            ...
                            BungeeCoreSystem.getInstance().getMessenger().sendSimple(sender, new TextComponent(BungeeCoreSystem.getInstance().getTranslationManager().get("system.bungee.chat.private.fromme").replaceAll("%Msg-Target%", t.getName()) + msg));
                ...
                BungeeCoreSystem.getInstance().getMessenger().send(sender, "§4Du hast keine offene Konversation!");
            }
        } else {
