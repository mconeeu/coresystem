...
@Getter
public enum LegacyItemData {

    ACACIA_BOAT(0, "BOAT_ACACIA"),
    ACACIA_BUTTON(0, "WOOD_BUTTON"),
    ACACIA_DOOR(0, "ACACIA_DOOR_ITEM", "ACACIA_DOOR"),
    ...
    BIRCH_DOOR(0, "BIRCH_DOOR_ITEM", "BIRCH_DOOR"),
    ...
    BREAD(0, "BREAD"),
    BREWING_STAND(0, "BREWING_STAND_ITEM", "BREWING_STAND"),
    BRICK(0, "CLAY_BRICK"),
    BRICKS(0, "BRICK"),
    BRICK_SLAB(4, "STEP"),
    ...
    CAULDRON(0, "CAULDRON_ITEM", "CAULDRON"),
    CAVE_AIR(0, "AIR"),
    ...
    CREEPER_HEAD((short) SkullType.CREEPER.ordinal(), "SKULL_ITEM", "SKULL"),
    CREEPER_SPAWN_EGG(50, "MONSTER_EGG"),
    CREEPER_WALL_HEAD((short) SkullType.CREEPER.ordinal(), "SKULL_ITEM", "SKULL"),
    ...
    DARK_OAK_DOOR(0, "DARK_OAK_DOOR_ITEM", "DARK_OAK_DOOR"),
    ...
    FLOWER_POT(0, "FLOWER_POT_ITEM", "FLOWER_POT"),
    ...
    JUNGLE_DOOR(0, "JUNGLE_DOOR_ITEM", "JUNGLE_DOOR"),
    ...
    PLAYER_HEAD((short) SkullType.PLAYER.ordinal(), "SKULL_ITEM", "SKULL"),
    PLAYER_WALL_HEAD((short) SkullType.PLAYER.ordinal(), "SKULL_ITEM", "SKULL"),
    PODZOL(2, "DIRT"),
    ...
    SKELETON_HORSE_SPAWN_EGG(100, "MONSTER_EGG"),
    ...
    SPRUCE_DOOR(0, "SPRUCE_DOOR_ITEM", "SPRUCE_DOOR"),
    ...
    WITHER_SKELETON_SKULL(0, "SKULL_ITEM", "SKULL"),
    WITHER_SKELETON_SPAWN_EGG(0, "MONSTER_EGG"),
    WITHER_SKELETON_WALL_SKULL(0, "SKULL_ITEM", "SKULL"),
    ...
    YELLOW_WOOL(4, "WOOL"),
    ZOMBIE_HEAD((short) SkullType.ZOMBIE.ordinal(), "SKULL_ITEM", "SKULL"),
    ...
    ZOMBIE_WALL_HEAD((short) SkullType.ZOMBIE.ordinal(), "SKULL_ITEM", "SKULL");

    private int legacyDurability;
    private String[] legacyMaterial;

    LegacyItemData(int legacyDurability, String... legacyMaterial) {
        this.legacyDurability = legacyDurability;
        this.legacyMaterial = legacyMaterial;
    }

    public static LegacyItemData getLegacyItemData(String newMaterialName) {
        for (LegacyItemData item : values()) {
            if (item.name().equalsIgnoreCase(newMaterialName)) {
                return item;
            }
        }
    ...
    public static String getNewMaterialName(Material material, int durablity) {
        for (LegacyItemData item : values()) {
            if (ArrayUtils.contains(item.legacyMaterial, material.name()) && item.legacyDurability == durablity) {
                return item.name();
            }
        }
    ...
    public static String getNewMaterialName(Material material) {
        return getNewMaterialName(material, 0);
    }
