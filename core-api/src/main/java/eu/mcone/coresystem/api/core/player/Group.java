...
public enum Group {
    ...
    SRCONTENT(13, "SrContent", "§2§oSrContent", "§8[§9SrCon§8] §7", ChatColor.BLUE, 23),
    DEVELOPER(20, "Developer", "§b§oDeveloper", "§8[§bDev§8] §7", ChatColor.AQUA, 30),
    BUILDER(21, "Builder", "§e§oBuilder", "§8[§eB§8] §7", ChatColor.YELLOW, 31),
    MODERATOR(22, "Moderator", "§2§oModerator", "§8[§2Mod§8] §7", ChatColor.DARK_GREEN, 32),
